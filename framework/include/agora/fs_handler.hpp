...
namespace agora
{
  ...
  class FsHandler
  {
    public:
      ...
      virtual void reset_doe( const application_description_t& description, const std::string& timestamp ) = 0;
      ...
      virtual observations_list_t load_client_observations( const std::string& application_name, const std::string& client_name, const std::string& query_select, const std::string& date,

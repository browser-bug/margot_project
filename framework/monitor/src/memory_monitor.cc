...
namespace margot
{
	...
	memory_monitor_t::memory_monitor_t(const std::size_t window_size, const std::size_t min_size): monitor_t( window_size, min_size ) {}



	void memory_monitor_t::extractMemoryUsage()
	{
	...
	memory_monitor_t::value_type memory_monitor_t::extractVmPeakSize()
	{

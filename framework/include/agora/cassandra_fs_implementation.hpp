...
namespace agora
{
  ...
  class CassandraClient: public FsHandler
  {
    ...
    public:
      ...
      void reset_doe( const application_description_t& description, const std::string& timestamp);
      ...
      observations_list_t load_client_observations( const std::string& application_name, const std::string& client_name, const std::string& query_select );

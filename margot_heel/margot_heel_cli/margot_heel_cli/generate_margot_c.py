...
def generate_block_body( block_model, op_list, cc ):
	...
	cc.write('\t{\n')
	cc.write('\t\tmargot::{0}::manager.configuration_rejected();\n'.format(block_model.block_name))
	cc.write('\t}')
	...
	for goal_model in block_model.goal_models:
		...
		cc.write('\t{\n')
		cc.write('\t\tmargot::{0}::goal::{1}.set<{2}>(static_cast<{2}>(new_value));\n'.format(block_model.block_name, goal_model.name, goal_model.stored_type_value))
		cc.write('\t}')

 ...
 * OperatingPoint.
 */
enum class OperatingPointSegments { SOFTWARE_KNOBS, METRICS };
 ...
 */
enum class DataFunctions { AVERAGE, STANDARD_DEVATION, MAXIMUM, MINIMUM };
 ...
 */
enum class ComparisonFunctions { GREATER, GREATER_OR_EQUAL, LESS, LESS_OR_EQUAL };
 ...
 */
enum class RankObjective { MAXIMIZE, MINIMIZE };
 ...
 * @see Rank
 */
enum class FieldComposer { GEOMETRIC, LINEAR, SIMPLE };
 ...
 */
enum class FeatureComparison { LESS_OR_EQUAL, GREATER_OR_EQUAL, DONT_CARE };

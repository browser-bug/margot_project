...
template <>
void FsHandler::create_env_configuration<PluginType::DOE>(PluginConfiguration &pc) {
...
template <>
void FsHandler::create_env_configuration<PluginType::Model>(PluginConfiguration &pc) {
    if (pc.metric_name.empty()) throw std::runtime_error("PluginConfiguration: the metric name must be specified");
...
template <>
void FsHandler::create_env_configuration<PluginType::Cluster>(PluginConfiguration &pc) {
    env_configuration_preamble(pc);
...
template <>
void FsHandler::create_env_configuration<PluginType::Prediction>(PluginConfiguration &pc) {
    env_configuration_preamble(pc);

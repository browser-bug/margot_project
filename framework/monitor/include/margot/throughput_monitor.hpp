...
#ifndef MARGOT_MONITOR_THROUGHPUT_MONITOR_HEADER
#define MARGOT_MONITOR_THROUGHPUT_MONITOR_HEADER
...
namespace margot
{
	 ...
	 */
	class throughput_monitor_t: public monitor_t<float>
	{
		public:
			 ...
			 *
			 */
			throughput_monitor_t(const std::size_t window_size = 1, const std::size_t min_size = 1);
...
#endif // MARGOT_MONITOR_THROUGHPUT_MONITOR_HEADER

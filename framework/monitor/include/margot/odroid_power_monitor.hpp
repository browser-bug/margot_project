...
#ifndef MARGOT_MONITOR_ODROID_POWER_MONITOR_HEADER
#define MARGOT_MONITOR_ODROID_POWER_MONITOR_HEADER
...
namespace margot
{
	 ...
	 */
	class odroid_power_monitor_t: public monitor_t<float>
	{
		public:
			 ...
			 *
			 */
			odroid_power_monitor_t(const std::size_t window_size = 1, const std::size_t min_size = 1);
		...
		private:
			...
			/**
			 * @brief The total power consumed
			 */
			//double total_power;
...
#endif // MARGOT_MONITOR_ODROID_POWER_MONITOR_HEADER

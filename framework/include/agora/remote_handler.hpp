...
inline void whitelist(message_t& incoming_string) {
  if (incoming_string.topic.find_first_not_of(
          "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ01234567890_/") != std::string::npos) {
  ...
  if (incoming_string.payload.find_first_not_of(

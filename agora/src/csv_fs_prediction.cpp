...
CsvPredictionStorage::CsvPredictionStorage(const FsConfiguration &configuration)
        : FsPrediction(configuration), csv_separator(configuration.csv_separator) {
...
void CsvPredictionStorage::store_prediction(const application_id &app_id, const margot::heel::block_model &description,
                                            const prediction_model &prediction) {

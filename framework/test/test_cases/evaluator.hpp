...
class Evaluator : public CxxTest::TestSuite
{
  public:
    ...
    void test_creation_point(void)
    {
      ...
      using second_knob_avg = margot::OPField<margot::OperatingPointSegments::SOFTWARE_KNOBS, margot::BoundType::LOWER, 1, 0>;
      using evaluator2 = margot::Evaluator<OperatingPointType, margot::FieldComposer::LINEAR, first_knob_avg, second_knob_avg>;
      ...
      using evaluator3 = margot::Evaluator<OperatingPointType, margot::FieldComposer::GEOMETRIC, first_knob_avg, second_knob_avg>;

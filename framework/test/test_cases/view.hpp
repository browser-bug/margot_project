...
class View : public CxxTest::TestSuite
{
  ...
  public:
    ...
    void test_rank_like( void )
    {
      ...
      using first_metric_1sigma = margot::OPField<margot::OperatingPointSegments::METRICS, margot::BoundType::UPPER, 0, 1>;
      using second_metric_1sigma = margot::OPField<margot::OperatingPointSegments::METRICS, margot::BoundType::UPPER, 1, 1>;
      margot::View<MyOperatingPoint, margot::FieldComposer::LINEAR, first_metric_1sigma, second_metric_1sigma> view(1.0f, 1.0f);

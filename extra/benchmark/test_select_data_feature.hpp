...
class SelectDataFeature {
  ...
  margot::DataAwareAsrtm<margot::Asrtm<MyOperatingPoint>, int, distance_type,
                         margot::FeatureComparison::DONT_CARE, margot::FeatureComparison::DONT_CARE,
 ...
 public:
  ...
  inline void operator()(void) {
    manager.select_feature_cluster(
        {{number_of_clusters - 3, number_of_clusters - 2, number_of_clusters - 1}});
  }
};

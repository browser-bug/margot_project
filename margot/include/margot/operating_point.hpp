...
class OperatingPoint {
 ...
 public:
   ...
   */
  inline SoftwareKnobsSegmentType get_knobs(void) const { return software_knobs; }
   ...
   */
  inline MetricsSegmentType get_metrics(void) const { return metrics; }
  ...
  inline metric_value_type get_metric_lower_bound(void) const {
    ...
    return metrics.template get_mean<metric_index>() -
           sigma * (metrics.template get_standard_deviation<metric_index>());
  }
  ...
  inline software_knobs_value_type get_knob_lower_bound(void) const {
    ...
    return software_knobs.template get_mean<knob_index>() -
           sigma * (software_knobs.template get_standard_deviation<knob_index>());
  }
...
template <class OperatingPoint, OperatingPointSegments target_segment, BoundType target_bound,
          std::size_t field_index, int sigma>
struct op_utils;
 ...
 */
template <class OperatingPoint, std::size_t field_index, int sigma>
struct op_utils<OperatingPoint, OperatingPointSegments::SOFTWARE_KNOBS, BoundType::LOWER, field_index,
                sigma> {
  static_assert(traits::is_operating_point<OperatingPoint>::value,
                "Error: the getter handles object with is_operating_point trait");
 ...
 */
template <class OperatingPoint, std::size_t field_index, int sigma>
struct op_utils<OperatingPoint, OperatingPointSegments::SOFTWARE_KNOBS, BoundType::UPPER, field_index,
                sigma> {
  static_assert(traits::is_operating_point<OperatingPoint>::value,
                "Error: the getter handles object with is_operating_point trait");
...
struct op_field_enumerator<OperatingPoint, OperatingPointSegments::METRICS, field_index> {
   ...
   */
  static constexpr std::size_t get(void) { return OperatingPoint::number_of_software_knobs + field_index; }
};
...
struct op_field_enumerator<OperatingPoint, OperatingPointSegments::SOFTWARE_KNOBS, field_index> {
   ...
   * @return The global index, as a compile time constant
   */
  static constexpr std::size_t get(void) { return field_index; }
};
